...
var start_value = Number(prompt('Введите целое число в промежутке [0..15]'))
...
switch(start_value){
    ...
    case 9: alert("9, 10, 11, 12, 13, 14, 15")
            break;
    case 10: alert("10, 11, 12, 13, 14, 15")
            break;
    case 11: alert("11, 12, 13, 14, 15")
            break;
    case 12: alert("12, 13, 14, 15")
            break;
    case 13: alert("13, 14, 15")
            break;
    case 14: alert("14, 15")
            break;
    case 15: alert("15")
